      ...
      <div className="container mx-auto px-4 py-12 md:py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map(service => (
                <div key={service.title} className="flex items-start gap-4 p-6 bg-secondary rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <Image src="https://placehold.co/600x400.png" width={600} height={400} alt="Construction site" data-ai-hint="building construction" className="rounded-xl object-cover w-full h-full"/>
             <Image src="https://placehold.co/600x400.png" width={600} height={400} alt="Interior finishing" data-ai-hint="interior construction" className="rounded-xl object-cover w-full h-full"/>
        </div>
      </div>
    </div>
    <Footer/>
